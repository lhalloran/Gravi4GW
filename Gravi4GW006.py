...
stn_x_array = 2606190.1 + 100*np.arange(-4,5)
stn_y_array = 1116135.25 + 100*np.arange(-4,5)
...
plt.imshow(DEM_z); plt.colorbar();
plt.title('Input DEM')

plt.figure(figsize=(10,8))
plt.contourf(stn_x_array, stn_y_array, dataproc[:,-1].reshape(stn_array_size))
plt.colorbar(); plt.title('dg/dH (uGal/mH2O)')